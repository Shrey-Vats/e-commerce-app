...
${colorConfig
  .map(([key, itemConfig]) => {
    const color =
      "theme" in itemConfig
        ? itemConfig.theme?.[theme as ThemeKeys]
        : itemConfig.color;
...
// Define our own payload interface based on recharts structure
...
interface ChartTooltipContentProps {
  ...
  color?: string;
  labelFormatter?: (value: any, payload: ChartPayload[]) => React.ReactNode;
  formatter?: (
    value: number | string,
    name: string,
    entry: ChartPayload,
